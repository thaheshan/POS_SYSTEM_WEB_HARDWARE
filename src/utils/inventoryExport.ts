...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Styles>
  ...
  <Style ss:ID="BarcodeStyle">
   ...
   <Font ss:FontName="Courier New" ss:Size="10" ss:Bold="1" ss:Color="#059669"/>
  </Style>
  <Style ss:ID="InStock">
  ...
  categoriesMap.forEach((items, categoryName) => {
    ...
    xml += `\n   </Row>`;
    xml += `\n   <Row ss:Height="18">`;
    xml += `\n    <Cell ss:MergeAcross="11" ss:StyleID="SubTitleStyle"><Data ss:Type="String">Exported: ${new Date().toLocaleString()} | Category Items: ${items.length}</Data></Cell>`;
    xml += `\n   </Row>`;
    xml += `\n   <Row ss:Height="10"/>`;
