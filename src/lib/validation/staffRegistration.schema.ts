...
export const staffRegistrationSchema = z
  ...
  .refine((data) => data.shop_id === data.shop_verification_id, {
    message:
      "This ID does not match the shop you selected. Please check with your owner.",
    path: ["shop_verification_id"],
  });

export type StaffRegistrationFormValues = z.infer<
  typeof staffRegistrationSchema
>;
