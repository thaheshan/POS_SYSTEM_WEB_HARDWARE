      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-2xl mx-auto space-y-4">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="bg-white rounded-2xl shadow-sm border border-gray-100 transition-all duration-300 hover:shadow-md"
            >
              <button
                type="button"
              ...
              <div
                id={`faq-answer-${index}`}
                className={`grid px-7 pb-6 transition-[grid-template-rows,opacity,margin] duration-300 ease-in-out ${
                  openIndex === index
