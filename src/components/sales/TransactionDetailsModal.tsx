          ...
          if (invoice) {
            ...
            if (realId && realId !== invoiceId) {
              try {
                ...
                console.warn(
                  "[TransactionModal] Re-fetch by realId failed:",
                  err,
                );
              }
            }
  ...
  const modalContent = (
    ...
    >
      <div className="bg-gray-50 w-full max-w-[1100px] h-[90vh] rounded-3xl shadow-2xl flex flex-col relative overflow-hidden">
        {/* ── HEADER ── */}
        <div
          className={`px-8 py-5 flex items-center justify-between text-white shrink-0 transition-colors duration-300 ${activeTab === "edit" ? "bg-emerald-600" : "bg-blue-600"}`}
        >
          <div className="flex flex-col">
            ...
            <p className="text-[11px] font-medium text-white/75 mt-0.5">
              ID: {invoiceId} | Created: {formattedDate}
              ...
              {activeTab !== "edit" && (
                <>
                  <button
                    ...
                    title="Delete"
                    className="w-9 h-9 rounded-lg bg-red-500/20 text-red-100 hover:bg-red-500 hover:text-white flex items-center justify-center transition-all"
                  >
          ...
          {(
            ...
            >
              ...
              {activeTab === id && id === "edit" && (
                <span className="bg-amber-100 text-amber-700 text-[9px] px-1.5 py-0.5 rounded-sm uppercase ml-1">
                  Active
                </span>
              )}
              {activeTab === id && (
                <div
                  className={`absolute bottom-0 left-0 w-full h-[3px] rounded-t-full ${id === "edit" ? "bg-emerald-600" : "bg-blue-600"}`}
                />
              )}
            </button>
          ))}
                    ...
                    <table className="w-full text-left">
                      <thead>
                        <tr className="border-b-2 border-gray-100">
                          <th className="pb-3 text-[10px] font-black text-gray-400 uppercase tracking-widest w-10">
                            #
                          </th>
                          <th className="pb-3 text-[10px] font-black text-gray-400 uppercase tracking-widest">
                            Product
                          </th>
                          <th className="pb-3 text-[10px] font-black text-gray-400 uppercase tracking-widest w-20 text-center">
                            SKU
                          </th>
                  ...
                  <div className="flex justify-end">
                    <div className="w-[360px] bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex flex-col gap-3">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-[22px] font-black text-blue-600 font-mono">
                          Rs. {totalAmount.toLocaleString()}
                        </span>
                      </div>
                    </div>
              ...
              {activeTab === "edit" && (
                <div className="max-w-[900px] mx-auto space-y-6 pb-28">
                  ...
                  <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex gap-3">
                    ...
                    <div>
                      <h5 className="text-[13px] font-black text-amber-900 mb-1">
                        Editing Active Transaction
                      </h5>
                      <p className="text-[12px] text-amber-800 font-medium">
                        Changes will update the invoice immediately upon saving.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-[1fr_280px] gap-6 items-start">
                    ...
                    <div className="space-y-4">
                      <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        <h4 className="text-[14px] font-black text-gray-900 mb-4">
                          Discount & Notes
                        </h4>
                        ...
                        {(() => {
                          ...
                          return (
                            <div className="flex flex-col gap-1 text-[12px] font-bold text-gray-700">
                              ...
                              <div className="border-t border-emerald-200 mt-1 pt-1 flex justify-between text-emerald-700 text-[14px] font-black">
                                <span>Total</span>
                                <span className="font-mono">
                                  Rs. {t.toLocaleString()}
                                </span>
        ...
        {activeTab !== "edit" && !loading && (
          <div className="absolute bottom-0 left-0 w-full bg-white border-t border-gray-100 px-8 py-4 flex items-center justify-end gap-3 shrink-0">
            ...
            <button
              onClick={onClose}
              className="px-6 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg text-[13px] font-bold transition"
            >
              Close
            </button>
          </div>
          ...
          <div className="absolute bottom-0 left-0 w-full bg-white border-t border-gray-100 px-8 py-4 flex items-center justify-between shrink-0">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 border border-gray-200 rounded-lg text-[13px] font-bold text-gray-600 hover:bg-gray-50 transition"
              >
