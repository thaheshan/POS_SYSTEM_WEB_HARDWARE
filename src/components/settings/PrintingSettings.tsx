import { Printer, Edit2, Plus, Terminal } from 'lucide-react';
      ...
      <div className="p-8">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 border border-gray-100 rounded-xl">
            ...
            <input 
              type="text" 
              defaultValue="Thank you for shopping with us! Goods sold are not returnable." 
              onChange={() => setHasUnsavedChanges(true)}
              className="w-[300px] px-3 py-2 border border-gray-200 rounded text-[12px] font-medium" 
            />
          </div>
