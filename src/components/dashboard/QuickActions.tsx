...
const actions = [
  { id: 1, label: 'New Sale', icon: ShoppingCart, color: 'text-white', bg: 'bg-[#1e3a8a]' },
      ...
      <div className="space-y-3">
        {actions.map((action) => (
          <button 
            key={action.id} 
            className={cn(
              "w-full flex items-center justify-between p-4 rounded-xl transition-all group hover:scale-[1.02]",
