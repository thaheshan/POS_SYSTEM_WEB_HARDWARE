    ...
    <div className="w-full min-h-screen bg-white">
      <div className="mx-auto max-w-2xl px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Owner Information</h1>
          <p className="text-gray-600">Tell us about yourself as the shop owner</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div>
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-500 text-xs mt-1">We'll send verification link to this email</p>
            </div>
          ...
          <div>
            <h2 className="text-lg font-bold text-gray-900 mb-6">Account Security</h2>
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  {...register('password')}
                  className="w-full pl-12 pr-12 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                />
                <button
                  type="button"
              ...
              <div className="mt-4 space-y-2">
                <p className="text-xs font-medium text-gray-600 mb-3">Password strength</p>
                ...
                <div className="space-y-2">
                  {PASSWORD_REQUIREMENTS.map(({ id, label }) => (
                    <div key={id} className="flex items-center gap-2">
                      ...
                      <span
                        className={`text-xs ${
                          passwordRequirements[id] ? 'text-gray-600' : 'text-gray-500'
                        }`}
                      >
                        {label}
                      </span>
